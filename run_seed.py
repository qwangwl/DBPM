...
#     tmp_saved_path = f"E:\\EEG\\logs\\0818-MixDBPM\\{dataset_name}_{session}\\main\\"
#     command = (
#         f"python main.py "
#         f"--seed {seed} "
...
tmp_saved_path = f"E:\\EEG\\logs\\0912-MixDBPM\\3to4"
command = (
    f"python main.py "
    f"--seed {seed} "
    f"--config {config_path} "
...
# for pre in [14, 18, 22, 28, 42, 56]:
#     tmp_saved_path = f"E:\\EEG\\logs\\0818-MixDBPM\\{dataset_name}_1\\params\\pre\\{pre}"
#     command = (
#         f"python main.py "
#         f"--seed {seed} "
#         f"--dataset_name {dataset_name} "
